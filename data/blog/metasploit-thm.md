...
How about finding more information out about the system itself? This might take a little bit of googling, what do we run to load mimikatz (more specifically the new version of mimikatz) so we can use it?
